...
public class ClienteController {
    ...
    public static Cliente registrar(){
        ...
        AppExamenBD.getListaCliente().add(cliente);
...
//    }
    ...
    public static Cliente buscar(String numeroDocumento){
        ...
        if (AppExamenBD.getListaCliente().size() > 0){
            for (Cliente auxCliente : AppExamenBD.getListaCliente()){
    ...
    private static int obtenerIdCliente(){
        ...
        int cantidadClientes = AppExamenBD.getListaCliente().size();
    ...
    private static boolean existeCliente(String numeroDocumento){
        ...
        if (AppExamenBD.getListaCliente().size() > 0){
            for (Cliente cliente : AppExamenBD.getListaCliente())
