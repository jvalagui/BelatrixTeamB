...
public class MeseroController {
    ...
    public static void registrar() {
        ...
        System.out.print("Ingresar el numero de documento del Persona: ");
        ...
        AppExamenBD.getListaMeseros().add(new Mesero(idMesero, numeroDocumento, nombre, apellidoPaterno, apellidoMaterno));
...
//    }
    ...
    public static void listar() {
        int contador = 0;
        if (AppExamenBD.getListaMeseros().size() > 0)
            for (Mesero mesero : AppExamenBD.getListaMeseros()) {
                contador++;
    ...
    private static int obtenerIdMesero() {
        ...
        int cantidadMeseros = AppExamenBD.getListaMeseros().size();
